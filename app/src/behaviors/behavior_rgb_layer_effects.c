...
#elif IS_ENABLED(CONFIG_ZMK_RGB_LAYER_EFFECTS)
...
static int on_keymap_binding_pressed(struct zmk_behavior_binding *binding,
    ...
    case RGB_HUI_CMD:
        {
            int ret = zmk_rgb_underglow_change_hue(1);
            update_layer_rgb();
            return ret;
        }
    case RGB_HUD_CMD:
    ...
    case RGB_SAI_CMD:
        {
            int ret = zmk_rgb_underglow_change_sat(1);
            update_layer_rgb();
            return ret;
        }
    case RGB_SAD_CMD:
    ...
    case RGB_BRI_CMD:
        {
            int ret = zmk_rgb_underglow_change_brt(1);
            update_layer_rgb();
            return ret;
        }
    case RGB_BRD_CMD:
    ...
    case RGB_LAYER_EFF_CMD:
        return rgb_set_layer_effect(binding->param2);
    }
